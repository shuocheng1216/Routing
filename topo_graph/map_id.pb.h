...
class Id : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.hdmap.Id) */ {
 public:
  ...
  static const Id* internal_default_instance();
  ...
  void UnsafeMergeFrom(const Id& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_map_5fid_2eproto_impl();
  friend void  protobuf_AddDesc_map_5fid_2eproto_impl();
  friend void protobuf_AssignDesc_map_5fid_2eproto();
  friend void protobuf_ShutdownFile_map_5fid_2eproto();

  void InitAsDefaultInstance();
};
extern ::google::protobuf::internal::ExplicitlyConstructed<Id> Id_default_instance_;
