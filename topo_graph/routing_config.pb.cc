...
void protobuf_AssignDesc_routing_5fconfig_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_routing_5fconfig_2eproto() {
  protobuf_AddDesc_routing_5fconfig_2eproto();
  ...
  RoutingConfig_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      RoutingConfig::internal_default_instance(),
...
void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_routing_5fconfig_2eproto);
}
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      RoutingConfig_descriptor_, RoutingConfig::internal_default_instance());
}

}  // namespace

void protobuf_ShutdownFile_routing_5fconfig_2eproto() {
  RoutingConfig_default_instance_.Shutdown();
  delete RoutingConfig_reflection_;
}

void protobuf_InitDefaults_routing_5fconfig_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  RoutingConfig_default_instance_.DefaultConstruct();
  RoutingConfig_default_instance_.get_mutable()->InitAsDefaultInstance();
}

GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_InitDefaults_routing_5fconfig_2eproto_once_);
void protobuf_InitDefaults_routing_5fconfig_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_InitDefaults_routing_5fconfig_2eproto_once_,
                 &protobuf_InitDefaults_routing_5fconfig_2eproto_impl);
}
void protobuf_AddDesc_routing_5fconfig_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  protobuf_InitDefaults_routing_5fconfig_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\024routing_config.proto\022\016apollo.routing\"\247"
    "\001\n\rRoutingConfig\022\022\n\nbase_speed\030\001 \001(\001\022\031\n\021"
    "left_turn_penalty\030\002 \001(\001\022\032\n\022right_turn_pe"
    "nalty\030\003 \001(\001\022\025\n\ruturn_penalty\030\004 \001(\001\022\026\n\016ch"
    "ange_penalty\030\005 \001(\001\022\034\n\024base_changing_leng"
    "th\030\006 \001(\001", 208);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "routing_config.proto", &protobuf_RegisterTypes);
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_routing_5fconfig_2eproto);
}

GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_routing_5fconfig_2eproto_once_);
void protobuf_AddDesc_routing_5fconfig_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_routing_5fconfig_2eproto_once_,
                 &protobuf_AddDesc_routing_5fconfig_2eproto_impl);
}
// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_routing_5fconfig_2eproto {
  StaticDescriptorInitializer_routing_5fconfig_2eproto() {
    protobuf_AddDesc_routing_5fconfig_2eproto();
  }
} static_descriptor_initializer_routing_5fconfig_2eproto_;
...
RoutingConfig::RoutingConfig()
  ...
  if (this != internal_default_instance()) protobuf_InitDefaults_routing_5fconfig_2eproto();
  SharedCtor();
...
::google::protobuf::internal::ExplicitlyConstructed<RoutingConfig> RoutingConfig_default_instance_;
...
void RoutingConfig::UnsafeMergeFrom(const RoutingConfig& from) {
...
inline const RoutingConfig* RoutingConfig::internal_default_instance() {
  return &RoutingConfig_default_instance_.get();
}
