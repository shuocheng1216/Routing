...
class ParkingSpace : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.hdmap.ParkingSpace) */ {
 public:
  ...
  static const ParkingSpace* internal_default_instance();
  ...
  void UnsafeMergeFrom(const ParkingSpace& from);
  private:
 ...
 private:
  ...
  double heading_;
  friend void  protobuf_InitDefaults_map_5fparking_5fspace_2eproto_impl();
  friend void  protobuf_AddDesc_map_5fparking_5fspace_2eproto_impl();
  friend void protobuf_AssignDesc_map_5fparking_5fspace_2eproto();
  friend void protobuf_ShutdownFile_map_5fparking_5fspace_2eproto();

  void InitAsDefaultInstance();
};
extern ::google::protobuf::internal::ExplicitlyConstructed<ParkingSpace> ParkingSpace_default_instance_;
...
class ParkingLot : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.hdmap.ParkingLot) */ {
 public:
  ...
  static const ParkingLot* internal_default_instance();
  ...
  void UnsafeMergeFrom(const ParkingLot& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<ParkingLot> ParkingLot_default_instance_;
